...
author: "Susan Vanderplas & Richard Stone"
date: "March 24, 2022"
output:
...
library(metathis)
meta() %>%
  meta_name("github-repo" = "srvanderplas/Presentations") %>%
  meta_social(
    title = "Automatic Acquisition of Footwear Class Characteristics",
    description = paste(
      "Shoe Scanning hardware and approach",
      "Presented at CSAFE Webinar"
    ),
    url = "https://srvanderplas.github.io/Presentations/2022-CSAFE-Webinar/",
    image = "https://srvanderplas.github.io/Presentations/2022-CSAFE-Webinar/social-card.png",
    image_alt = paste(
      "Automatic Acquisition of Footwear Class Characteristics",
      "Shoe Scanning hardware and approach",
      "Presented as a CSAFE Webinar by Susan Vanderplas & Richard Stone"
    ),
    og_type = "website",
    og_author = "Susan Vanderplas",
    twitter_card_type = "summary_large_image",
    twitter_creator = "@srvanderplas",
    twitter_site = "@srvanderplas"
  )
```
